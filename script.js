...
const equations = [
    ...
    { equation: "NO2 -> N2O4", reactants: [{ formula: "NO2", coefficient: 1 }], products: [{ formula: "N2O4", coefficient: 1 }] },
    { equation: "N2O4 -> NO2", reactants: [{ formula: "N2O4", coefficient: 1 }], products: [{ formula: "NO2", coefficient: 1 }] },
